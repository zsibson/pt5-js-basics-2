...
class Ticket {
    ...
    updateStatus=()=> `The order for customer ${this.customerId} is now ${this.status}.`
...
//CODE HERE
const firstTicket = new Ticket("food ordered: pizza, bread, and soda",
"ordered at: 7:03 PM", "customer: 575"
)
